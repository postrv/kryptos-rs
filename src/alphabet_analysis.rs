...
pub fn score_substring(substring: &str) -> f64 {
    ...
    let common_words: HashSet<&str> = vec![
        "THE", "AND", "THAT", "HAVE", "FOR", "NOT", "WITH", "YOU", "THIS", "BUT", "KRYPTOS", "ABSCICCA", "PALIMPSEST", "AGENTS", "BETWEEN", "CLOCK", "SHADOW", "FORTY", "IT", "IS", "BERLIN", "NORTH", "EAST", "SOUTH", "WEST", "FOLLOW", "THE", "LEFT", "HAND", "PATH", "NORTHEAST", "SOUTHEAST", "SOUTHWEST", "NORTHWEST", "RIGHT"
